...
> **Key Takeaway:** If your `utm_medium` value doesn't match GA4's expected list (e.g. `email`, `cpc`, `social`, `display`), your traffic lands in "Unassigned" and becomes nearly impossible to analyse by channel.
