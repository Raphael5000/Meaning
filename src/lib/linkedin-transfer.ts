...
export const LINKEDIN_KEY_COLUMNS: Record<string, string[]> = {
  post_performance: ["post_urn"],
  follower_stats: ["stats_date"],
  follower_demographics: ["stats_date", "dimension", "dimension_value"],
  page_stats: ["stats_date"],
