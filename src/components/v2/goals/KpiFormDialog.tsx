        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-4 space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                id="kpi-name"
                placeholder="e.g. Monthly Meta Leads"
                value={name}
            ...
            {!isEdit && (
              <div className="space-y-1.5">
                ...
                <Input
                  id="kpi-desc"
                  placeholder="e.g. Number of leads from Meta per month"
                  value={metricDescription}
                  onChange={(e) => setMetricDescription(e.target.value)}
                />
                <p className="text-[11px] text-muted-foreground">
                  Describe what to measure. We&apos;ll match it to your connected data or manual metrics automatically.
                </p>
              </div>
            )}
