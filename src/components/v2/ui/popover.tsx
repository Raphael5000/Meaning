...
>(({ className, align = "center", sideOffset = 6, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        "meaning-v2 z-50 rounded-[10px] border border-v2-line bg-v2-surface p-2 text-v2-ink outline-none shadow-[0_24px_60px_-18px_rgba(0,0,0,0.35),_0_0_0_1px_var(--v2-line)]",
